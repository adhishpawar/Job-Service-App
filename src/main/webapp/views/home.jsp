...
<title>Adhish's' Job Portal</title>
<link
...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-clr">
		<div class="container">
			<a class="navbar-brand fs-1 fw-medium " href="#">Adhish's Job
				Portal Web App</a>
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href="https://www.linkedin.com/in/adhish-pawar-153241231/">Contact</a></li>
				</ul>
			</div>
		</div>
	</nav>
